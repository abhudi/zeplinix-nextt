...
const Banner: React.FC = () => {
  return (
    <div className="relative w-full h-auto sm:h-[100%] lg:h-[40rem] flex flex-col lg:flex-row items-center justify-center overflow-hidden bg-gray-800 text-white mb-8 lg:px-10">
